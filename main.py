...
BOT_IMAGE = os.environ.get("BOT_IMAGE", "https://telegra.ph/file/ca8bdaec1e2409d4c3fd8.jpg")
BOT_USERNAME = os.environ.get("BOT_USERNAME", "Suzie_chat_bot")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME", "itz_rocks_krishna")
SUPPORT_GROUP = os.environ.get("SUPPORT_GROUP", "Frienddd_zoneee")
UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "Frienddd_zoneee")
...
@bot.on_message(filters.command(["/start", f"start@{BOT_USERNAME}", "/alive", ".alive"]) & filters.group & ~filters.edited)
...
async def chatbotofd(client, message):
    ...
    if not is_v:
        ...
        await message.reply_text(f"🌷 ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇ 🌷")
    if is_v:
        await message.reply_text(f"🌷 ᴄʜᴀᴛʙᴏᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴅɪsᴀʙʟᴇ 🌷")
...
async def chatboton(client, message):
    ...
    is_v = v.find_one({"chat_id": message.chat.id})
    if not is_v:           
        await message.reply_text(f"🌷 ᴄʜᴀᴛʙᴏᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴇɴᴀʙʟᴇ 🌷")
    if is_v:
